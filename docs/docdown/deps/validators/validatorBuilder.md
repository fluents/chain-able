...
library of validators to use by name
...
add custom types for validation
...
transform arithmetic strings into types
...
@pattern @builder -> builds using multiple factories depending on conditons or abstractFactory whatever opinionated: if it's a function, it's a validator...
