...
[visitor-pattern]: https://sourcemaking.com/design_patterns/visitor <!-- NAMED_LINK -->
...
options for merging with dopemerge
...
merges object in, goes through all keys, checks cbs, dopemerges
